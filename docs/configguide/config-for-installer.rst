...
2. How to add onos into compass
   ...
   2.1 the script that install onos service is added into the compass4nfv project. and the onos will be started when compass called the onos script.
       the script is included in the directory of compass4nfv project below::
